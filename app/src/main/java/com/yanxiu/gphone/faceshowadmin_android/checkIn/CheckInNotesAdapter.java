...
public class CheckInNotesAdapter extends BaseRecyclerViewAdapter {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(GetCheckInNotesResponse.DataBean.SignInsBean data) {
            checkInItemTitle.setText(data.getTitle());
            hasCheckInProportion.setText(itemView.getContext().getString(R.string.has_check_in_proportion, data.getSignInUserNum(), data.getTotalUserNum()));
            ...
            String time = startTimes[0] + " " + startTime[0] +":"+ startTime[1] + "-" + endTime[0] +":"+ endTime[1];
    ...
    static String getPercent(int y, int z) {
        if (y == 0) {
            return "0%";
        } else {
