...
import com.yanxiu.gphone.faceshowadmin_android.course.adapter.ReplyDetailAdapter;
...
public class ReplyDetailActivity extends FaceShowBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStepId = getIntent().getStringExtra("questionId");
                ...
                if (ResponseConfig.SUCCESS == ret.getCode()) {
                    if (ret.getData().getElements() != null && ret.getData().getElements().size() > 0) {
                        ...
                        if (mReplyDetailAdapter==null){
                            ...
                            mReplyDetailAdapter = new ReplyDetailAdapter(mRecords, mDescription, String.valueOf(ret.getData().getTotalElements()));
                            mRecyclerView.setAdapter(mReplyDetailAdapter);
                        }else {
                            mReplyDetailAdapter.update(mRecords, mDescription, String.valueOf(ret.getData().getTotalElements()));
                        }
                    } else {
