 ...
 * Function :
 */
public class PublishedMomentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PublishedMomentAdapter(Context context) {
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        if (payloads.isEmpty()) {
            ...
            final ClassCircleResponse.Data.Moments moments = mData.get(position);
    ...
    private void setViewVisibly(ClassCircleViewHolder classCircleViewHolder, ClassCircleResponse.Data.Moments moments) {
        ...
        if (isSelf) {
            classCircleViewHolder.mCommentDel.setVisibility(View.VISIBLE);
