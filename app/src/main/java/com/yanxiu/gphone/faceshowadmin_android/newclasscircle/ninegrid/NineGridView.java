package com.yanxiu.gphone.faceshowadmin_android.newclasscircle.ninegrid;
...
//                gridWidth = gridHeight = (totalWidth - gridSpacing * (columnCount - 1)) / columnCount;
    ...
    NineGridViewWrapper.onViewOntouch mViewOntouch=null;


    public void setViewOntouch(NineGridViewWrapper.onViewOntouch viewOntouch){
        mViewOntouch=viewOntouch;
    }
    ...
    private ImageView getImageView(final int position) {
        ...
        if (position < imageViews.size()) {
            ...
            ((NineGridViewWrapper)imageView).setViewOntouch(mViewOntouch);
