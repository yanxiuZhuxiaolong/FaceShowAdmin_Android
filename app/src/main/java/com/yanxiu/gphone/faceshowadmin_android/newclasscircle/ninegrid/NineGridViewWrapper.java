...
public class NineGridViewWrapper extends ImageView {
    ...
    onViewOntouch mViewOntouch;

    public interface onViewOntouch{
        void onViewTouch(MotionEvent event);
    }

    public void setViewOntouch(onViewOntouch viewOntouch){
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mViewOntouch!=null){
            mViewOntouch.onViewTouch(event);
        }
