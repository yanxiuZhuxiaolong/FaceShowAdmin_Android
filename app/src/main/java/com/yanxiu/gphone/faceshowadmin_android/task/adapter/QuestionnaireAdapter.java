...
public class QuestionnaireAdapter extends RecyclerView.Adapter<QuestionnaireAdapter.BaseViewHolder> {
    ...
    class HeadViewHolder extends BaseViewHolder {
        ...
        public void setData(Object obj) {
            ...
            mTvVotedPersonNumber.setText(Html.fromHtml(itemView.getContext().getString(R.string.submit_person_number, qusetionGroupBean.getAnswerNum(), qusetionGroupBean.getTotalUserNum())));
