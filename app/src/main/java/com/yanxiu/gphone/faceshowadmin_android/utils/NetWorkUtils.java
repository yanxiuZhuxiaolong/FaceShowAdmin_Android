...
public class NetWorkUtils {
    ...
    public static NetworkInfo getAvailableNetWorkInfo() {
        ...
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) FSAApplication.getInstance().getApplicationContext()
    ...
    public static boolean isNetworkAvailable() {
        ConnectivityManager cm = (ConnectivityManager) FSAApplication.getInstance().getApplicationContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
        } else {
            //如果仅仅是用来判断网络连接
